...
<p align="center">
  ...
  <h3 align="center">Healthy Programmer Notifier</h3>
...
This is python notifier app which helps in maintaining the health of programmers!
...
- Clone the repo
   ```sh
   git clone https://github.com/Aaryan-R-S/Python-Projects-Healthy-Programmer-Notifier.git
   ```
- Python Modules
  - `pip install pygame` 
